...
import com.Bhailal_Chauhan.retailapp.view.adapter.ProductOverViewPagerAdapter;
import com.Bhailal_Chauhan.retailapp.view.fragment.ProductListFragment;
...
public class ProductLoaderTask extends AsyncTask<String, Void, Void> {
	...
	protected Void doInBackground(String... params) {
		...
		FakeWebServer.getFakeWebServer().getVeg();
//		FakeWebServer.getFakeWebServer().getFruits();
		return null;
	}
